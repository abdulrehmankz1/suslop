      ...
      <div className="container mx-auto">
        <div className="flex lg:flex-nowrap flex-wrap w-full xl:gap-9 lg:gap-7 gap-9">
          ...
          <div className="w-full xl:w-2/5 lg:w-3/6">
            <h2 className="text-start text-dark">What You’ll Find Here</h2>
            <div className="xl:my-12 lg:my-8 md:my-8 my-5">
              <div className="xl:pb-7 lg:pb-4 md:pb-5 pb-3 border-b border-[#0E0E0E4D]">
                <h4 className="text-dark">Industry Commentary</h4>
                <p className="text-dark opacity-[0.7] mt-2.5">
                  Timely insights into environmental, social, and regulatory
                  changes affecting communities and industries.
                </p>
              </div>
              <div className="xl:py-7 lg:py-4 md:py-5 py-3 border-b border-[#0E0E0E4D]">
                <h4 className="text-dark">Project Learnings</h4>
                <p className="text-dark opacity-[0.7] mt-2.5">
                  Behind-the-scenes perspectives from our work across sectors.
                </p>
              </div>
              <div className="xl:pt-7 lg:pt-4 md:pt-5 pt-3">
                <h4 className="text-dark">Innovation Highlights</h4>
                <p className="text-dark opacity-[0.7] mt-2.5">
                  Exploring tools, methods, and approaches driving better
                  outcomes.
                </p>
              </div>
              <div className="xl:pt-7 lg:pt-4 md:pt-5 pt-3">
                <h4 className="text-dark">Community Voices</h4>
                <p className="text-dark opacity-[0.7] mt-2.5">
                  Stories and viewpoints from the people and partners we work
                  with.
                </p>
              </div>
            </div>
